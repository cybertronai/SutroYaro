...
Write a report titled `findings/kimi_asi_memory.md` detailing exactly how we can map the ASI-Evolve 'Analyzer' and 'Cognition Base' abstractions onto our existing SutroYaro markdown files.
...
**CRITICAL CONSTRAINT**: This is an analysis only. DO NOT modify any lab files. DO NOT modify `DISCOVERIES.md`, `LAB.md`, `CLAUDE.md`, `AGENT.md`, or any `src/` files. Write only to `findings/kimi_asi_memory.md`.
