...
Discussion: [[https://t.me/sutro_group](https://t.me/sutro_group)]
...
Meeting in Accel board room

Hinton's Forward-Forward algorithm

notes -  [[Hinton's Forward-Forward Paper Discussion](https://docs.google.com/document/d/1IdXRUhPRoWt8xLH1Y6iRWRx1g9-gbotFiiAnVixJYZY/edit?tab=t.0)]

Jamie Simon implementation results [[doc](https://docs.google.com/document/d/1u8pIWg2iWc9R-dQgXz2Yt6xgF2fWP0GbDipbIxF1v1Y/edit?tab=t.0)]

## Meeting #3, 02 Feb 26 

Meeting in SPC

Joules-measuring colab [[notebook](https://colab.research.google.com/drive/1ctren0aejK4KI9AYclUrGbDYZrDqSiJS#scrollTo=kdhH19I9XvDZ)]

Barak showed his Modal workflow, Yaroslav showed his Colab workflow

## Meeting #4, 09 Feb 26 

Meeting in Palmer Square

Notes: [[From_Beauty_to_Joules.pdf](https://drive.google.com/open?id=1T2jTdXnS5L7JGri5clrCz4hRslxIr6Vg&usp=drive_fs)]

## Meeting #5, 16 Feb 26 

Notes: [[Intelligence_Per_Joule.pdf](https://drive.google.com/open?id=1vyvElj7aTFZYwNpA1mzHAaLSJegmAson&usp=drive_fs)]
...
- Improve baseline to reduce the number of total operations without reducing accuracy
...
Germaine presentation:[[germaine.mp4](https://drive.google.com/file/d/1BzZLWCveiXRAXj2nAsYYDoPnPe8lDDki/view?usp=sharing)]

Emmett's results: [[doc](https://docs.google.com/document/d/1DAwx_gohi6tomMPkb_fETAIuxIyHgLtC5OPD_qpGpqg/edit?tab=t.0)]
...
 [[sutro group homework: Drosophilla of learning](https://docs.google.com/document/d/16eeltCaTpiiM1t_m_5BSxRnqxoMoiJ-xn4cy0x-TFgc/edit?tab=t.0)]

Meeting #8, 09 Mar 26

## Meeting #8, 09 Mar 26 

Notes: [[Sutro meeting #8 notes](https://docs.google.com/document/d/12AnIc4XWH0OBloZCgShaaqg3oASXBVF3kLjegHhH0FI/edit?tab=t.0#heading=h.gf7clh5k07pc)]
...
- Germain demos his supervisor/researcher harness, solutions seemed to prefer methods from 2010s 

- Uliana gave suggestions on the temperature to use in Germain's experiments

### Homework for next Monday 

1. Get agents to improve [[sutro group challenge #1: sparse parity](https://docs.google.com/document/d/16eeltCaTpiiM1t_m_5BSxRnqxoMoiJ-xn4cy0x-TFgc/edit?tab=t.0)] (using ARD as the proxy for energy)
