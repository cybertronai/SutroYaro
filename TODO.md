...
- [x] Task A: ARD on winning config — [findings](docs/findings/exp_a_ard_winning.md)
- [x] Task B: Instrument mini-batch SGD for ARD — [findings](docs/findings/exp_b_batch_ard.md)
- [x] Task C: Per-layer forward-backward on winning config — [findings](docs/findings/exp_c_perlayer_20bit.md)
- [x] Task D: Scale stress test (n=50, n=100, k=5) — [findings](docs/findings/exp_d_scaling.md)
- [x] Task E: Forward-Forward on sparse parity — [findings](docs/findings/exp_e_forward_forward.md)
...
**Related work**: The [Pebble Game experiment](docs/findings/exp_pebble_game.md) explored 5,758 topological orderings of the backward pass and found optimal orderings. This is a partial answer.

### What to do
1. Read `src/sparse_parity/tracker.py` and `src/sparse_parity/train.py`
2. Read `docs/findings/exp_pebble_game.md` for prior work on operation reordering
...
- `docs/findings/exp_pebble_game.md`
